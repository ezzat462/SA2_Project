...
namespace DriveShare.API.Migrations
{
    ...
    [Migration("20260415161800_AddCarAvailability")]
    partial class AddCarAvailability
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DriveShare.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            LicenseStatus = 1,
                            PasswordHash = "AQAAAAIAAYagAAAAEEU/vx+HfPYoIKuf8nTuGLVyl+4Uy362zC/gwtK7U3RUnRYLe7rPilZpdR8aXnWOUg==",
                            Role = 0
                        });
                });
