...
namespace DriveShare.API.Migrations
{
    ...
    [Migration("20260422191523_CompletePlatformUpgrade")]
    partial class CompletePlatformUpgrade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DriveShare.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            LicenseStatus = 1,
                            PasswordHash = "AQAAAAIAAYagAAAAEAGnaoR/h35yYak78lmyN4eA1oO4J9n4OkmXiIqX6/Y97Ex4ubPH40G+aFWKZ7GgNA==",
                            Role = 0
                        });
                });
