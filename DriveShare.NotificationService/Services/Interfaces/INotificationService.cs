...
namespace DriveShare.NotificationService.Services.Interfaces
{
    public interface INotificationService
    {
        ...
        Task<ApiResponse<List<Notification>>> GetMyNotificationsAsync(int userId, bool isAdmin = false);
        Task<ApiResponse<bool>> MarkAsReadAsync(int notificationId, int userId, bool isAdmin = false);
        Task<ApiResponse<bool>> MarkAllAsReadAsync(int userId, bool isAdmin = false);
    }
}
