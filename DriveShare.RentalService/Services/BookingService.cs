    ...
    public class BookingService : IBookingService
    {
        ...
        public async Task<ApiResponse<BookingDto>> CreateBookingAsync(BookingRequestDto request, int renterId)
        {
            ...
            await _kafkaProducer.ProduceAsync("user-targeted-topic", new DriveShare.Shared.Events.UserTargetedEvent
            {
                ...
                Message = $"You have a new booking request for your {car.Brand} {car.Model}!"
            });
        ...
        public async Task<ApiResponse<bool>> AcceptBookingAsync(int bookingId, int ownerId)
        {
            ...
            await _kafkaProducer.ProduceAsync("user-targeted-topic", new DriveShare.Shared.Events.UserTargetedEvent
            {
                ...
                Message = $"Your booking request for the {booking.Car.Brand} {booking.Car.Model} has been accepted!"
            });
        ...
        public async Task<ApiResponse<bool>> RejectBookingAsync(int bookingId, int ownerId)
        {
            ...
            await _kafkaProducer.ProduceAsync("user-targeted-topic", new DriveShare.Shared.Events.UserTargetedEvent
            {
                ...
                Message = $"Your booking request for the {booking.Car.Brand} {booking.Car.Model} was unfortunately rejected."
            });
