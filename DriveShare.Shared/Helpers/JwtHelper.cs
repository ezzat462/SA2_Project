...
namespace DriveShare.Shared.Helpers
{
    public class JwtHelper
    {
        ...
        public string CreateToken(int userId, string email, string fullName, string role, string approvalStatus)
        {
            var claims = new List<Claim>
            {
                ...
                new Claim("approvalStatus", approvalStatus)
            };
